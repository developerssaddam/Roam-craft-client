  ...
  return (
    <footer className="px-4 divide-y bg-gray-800 text-gray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            ...
            <span className="self-center text-2xl font-semibold font-oswald">
              RoamCraft
            </span>
          </a>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text-gray-50">RoamCraft</h3>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  Privacy
      ...
      <div className="py-6 text-sm text-center text-gray-400">
        © 2024 RoamCraft. All rights reserved.
      </div>
    </footer>
  );
};
