...
const MatchTouristSpotCard = () => {
  const _id = 1;

  return (
    <div className="shadow-lg rounded-lg border">
      <div className="p-5 space-y-2 font-medium">
        <h2 className="text-xl text-center text-[#1C1678] font-oswald font-semibold mb-4">
          Name : Name Hobe
        </h2>
        ...
        <div>
          ...
          <p>
            ...
            nisi corrupti ex voluptatem magni quidem, facilis nam laboriosam
            quisquam hic.
          </p>
        </div>
