  ...
  return (
    <div>
      <div className="my-8 text-center max-w-4xl mx-auto space-y-4 p-4">
        <h2 className="text-2xl font-oswald">Our Team</h2>
        <p className="italic">
          Explore the wonders of RoamCraft! Our team at RoamCraft Tourism
          invites you to embark on unforgettable adventures, discover hidden
          gems, and create lasting memories in breathtaking destinations
          worldwide. Join us today!
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5 mb-10">
        <div className="shadow-lg relative">
          ...
          <div className="absolute right-0 top-0">
            <p className="p-1 bg-[#3C5B6F] mb-1 cursor-pointer">
